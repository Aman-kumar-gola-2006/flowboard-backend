...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList(frontendUrl, "https://flowboard-taskmanager.netlify.app"));
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .oauth2Login(oauth2 -> oauth2
                        ...
                        .successHandler(oAuth2SuccessHandler).failureUrl(frontendUrl + "/login?error=oauth2"));
    ...
    private OAuth2AuthorizationRequestResolver authorizationRequestResolver(
        ...
        authorizationRequestResolver
                .setAuthorizationRequestCustomizer(customizer -> customizer.additionalParameters(params -> {
                    // Check if the current registration is google
