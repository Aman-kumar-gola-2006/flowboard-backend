...
public class EmailService {
    ...
    public void sendWelcomeEmail(String to, String name) {
        ...
        String html = getHtmlTemplate("Welcome to FlowBoard 🚀", name, content, "Log In to Workspace", "http://3.110.61.209.nip.io:4200/login");
    ...
    public void sendProUpgradeEmail(String to, String name) {
        ...
        String html = getHtmlTemplate("You're a PRO Member! 💎", name, content, "Go to Dashboard", "http://3.110.61.209.nip.io:4200/dashboard");
    ...
    public void sendSupportEmail(String fromName, String fromEmail, String subject, String problem) {
        ...
        String html = getHtmlTemplate("Support Request Received", "Admin", content, "Respond in Admin Panel", "http://3.110.61.209.nip.io:4200/admin");
